...
CREATE TABLE project (
	...
	p_pc1name NUMBER NOT NULL, /* 1차 카테고리 이름 */
	p_pc2name NUMBER NOT NULL, /* 2차 카테고리 이름 */
	...
	p_plnum1 NVARCHAR2(20) NOT NULL, /* 프로젝트 필요 언어1 */
	p_plnum2 NVARCHAR2(20) NOT NULL, /* 프로젝트 필요 언어2 */
	p_person NUMBER NOT NULL, /* 프로젝트 인원 */
	p_status NUMBER NOT NULL, /* 상태 아이디 */
	p_vol NUMBER NOT NULL, /* 프로젝트 지원자수 */
	p_bookmark NUMBER NOT NULL /* 프로젝트 즐겨찾기 */
);
...
CREATE TABLE verylike (
	...
	l_mid NVARCHAR2(20) NOT NULL /* 회원 아이디 */
);
...
CREATE TABLE project_bookmark (
	...
	pb_id NVARCHAR2(20) NOT NULL, /* 프로젝트 즐겨찾기 한 아이디 */
