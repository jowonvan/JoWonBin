...
<script>
	function writeCmt() {
		...
		document.rvinfoForm.action = 'comment';
		document.rvinfoForm.submit();
	}
	function rvList() {
		document.rvinfoForm.action = 'reviewMain';
		document.rvinfoForm.submit();

	}

	function commentbtn() {
		document.commentForm.action = 'reviewcomment';
			...
			<div class="sns_wrap">
				...
				<p>
					<a
						...
						title="페이스북으로 가져가기"><img src="img/facebook.PNG"></a> <a
						href="javascript:toSNS('twitter','공유제목!','http://http://단축URL')"
						title="트위터로 가져가기"><img src="img/twitter.PNG"></a> <a
						href="javascript:toSNS('line','공유제목!','http://http://단축URL')"
						title="라인으로 가져가기"><img src="img/naverline.PNG"></a> <a
						href="javascript:toSNS('pholar','공유제목!','http://단축URL')"
						title="폴라로 가져가기"><img src="img/pholar.PNG"></a> <a
						href="javascript:toSNS('pinterest','공유제목!','http://단축URL')"
						title="핀터레스트로 가져가기"><img src="img/pinterest.PNG"></a> <a
						href="javascript:toSNS('band','공유제목!','http://단축URL')"
						title="밴드로 가져가기"><img src="img/band.PNG"></a> <a
						href="javascript:toSNS('google','공유제목!','http://http://단축URL')"
						title="구글플러스로 가져가기"><img src="img/googleplus.PNG"></a> <a
						href="javascript:toSNS('blog','공유제목!','http://http://단축URL')"
						title="네이버블로그로 가져가기"><img src="img/naver.png"></a>
				</p>
				해당 URL <input type="text"
					value="http://localhost/LSOT4/reviewMain?page=1"> <a
					href="javascript:copy_clip('http://localhost/LSOT4/reviewMain?page=1')">
					복사</a> <br />
			</div>
		</div>
		<div id="footer">
