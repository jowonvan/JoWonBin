...
<script>
	function insertInput(obj) {
		document.AddPage.action = 'tgAddPage?kind=' + '${kind}';
...
<body>
	<div id="contents">
		...
		<div id="section">
			<div id="adder">
				<form id="AddpageForm" enctype="multipart/form-data" name="AddPage" method="post">
					<h1>재능 기부받기</h1>
					<div class="floor">
					...
					<div class="floor">
						<div class="lefter">사진 첨부</div>
						<div class="righter">
							<input type="file" name="t_fileName" />
						</div>
					</div>
					<p id="submitBtn">
						<input type="hidden" value="개인" name="addKind" /> <input
							type="hidden" value="단체" name="addKind" /> <input type="button"
							value="재능 기부 받기" onclick="insertInput(this)" />
					</p>
				</form>
			</div>
		</div>
