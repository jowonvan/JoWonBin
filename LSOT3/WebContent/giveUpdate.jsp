...
<body>
	<div id="contents">
		...
		<div id="section">
			<div id="adder">
				<form id="addPageForm" name="updateForm">
					...
					<div class="floor">
						...
						<div class="righter">
							...
							</select> <select name=second size=1>
					...
					<p id="submitBtn">
						<input type="button" value="재능기부하기" onclick="updateBtn()"/>
					</p>
				</form>
			</div>
		</div>
...
<script>
	...
	function firstChange() {// 대분류 변한 경우
		var x = document.updateForm.first.options.selectedIndex;//선택한 인덱스
		var groups = document.updateForm.first.options.length;//대분류 갯수
		...
		temp = document.updateForm.second;//두번 째 셀렉트 얻기(<select name=second>)
	...
	function updateBtn(){
		document.updateForm.action="giveupdate";
