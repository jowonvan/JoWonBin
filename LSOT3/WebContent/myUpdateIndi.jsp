...
<body>
	<div id="contents">
		<div id="header"></div>
		<div id="joinForm">
			<h1 style="text-align: center;">회원정보수정 - 개인 / 일반</h1>
			<br />
			<form id="joinIndiForm" name="joinIndiForm">
				<p>
					<span class="lefter">아이디 : ${id}</span> <span class="righter">이름
						: <input type="text" name="name" class="sizing" value="${name}" />
					</span>
				</p>
				<br />
				<p>
					<span class="lefter">비밀번호 : <input type="password" id="pw"
						name="pw" class="sizing" /></span> <span class="righter">비밀번호 확인
				...
				<br />
				<p>
					<span class="lefter">핸드폰 : <select name="phoneValue"
						class="sizing">
						...
						name="third" class="sizing" /></span> <span class="righter">이메일 :
						<input type="text" name="email" class="sizing" value="${email}" />
					</span>
				</p>
				<br />
				<p style="clear: both;" id="addressI">
				...
				<p>
					<span class="lefter">성별 : <input type="radio" value="남성"
						name="gender" />남성 <input type="radio" value="여성" name="gender" />여성
				...
				<br />
				<p>
					<span class="lefter">생일 : <input type="text" name="birth"
						placeholder="ex : 20170101" class="sizing" value="${birth}" /></span> <span
						class="righter">비밀번호 질문 답 : <input type="text"
						name="pwAnswer" class="sizing" /></span>
				</p>
				<input type="hidden" name="kind" value="개인" /> <input type="hidden"
					name="point" value="0" /> <br />
				<h6>비밀번호를 확인해 주십시오.</h6>
				<p style="clear: both; text-align: center;">
					<input type="button" value="회원정보 수정" id="joinResult" class="sizing"
						onclick="confirm()" /> <input type="button" value="뒤로가기"
						id="toBack" class="sizing" />
				</p>
			</form>
		</div>
		<div id="footer">
...
<script>
	...
	function uupdate() {
		document.joinIndiForm.action = "myUpdate";
		document.joinIndiForm.submit();
	}
