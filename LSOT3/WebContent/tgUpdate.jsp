		...
		<div id="section">
			<div id="adder">
				<form name="updateForm">
					...
					<p id="submitBtn">
						<input type="hidden" value="${t_code}" name="t_code" /> <input
							type="hidden" value="${t_title}" name="t_title" /> <input
							type="hidden" value="${t_kind}" name="t_kind" /> <input
							type="hidden" value="${t_mid}" name="t_mid" />
