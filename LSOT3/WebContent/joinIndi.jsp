...
<body>
	<div id="joinForm">
		<h1 style="text-align: center;">회원가입 - 개인 / 일반</h1>
		<br/>
		<form name="joinIndiForm">
			<p>
				아이디 : <input type="text" name="id" class="sizing"/>
			</p>
			<p>
				비밀번호 : <input type="password" id="pw" name="pw" class="sizing"/>
			</p>
			<p>
				비밀번호 확인 : <input type="password" id="pwConfirm" name="pwConfirm" class="sizing"/>
			</p>
			<p>
				이름 : <input type="text" name="name" class="sizing"/>
			</p>
			<p>	
				핸드폰 : <select name="phoneValue" class="sizing">
			...
			<p>	
				생일 : <input type="text" name="birth" placeholder="ex : 20170101" class="sizing"/>
			</p>
			<p>
			...
			<p>
				비밀번호 질문 답 : <input type="text" name="pwAnswer" class="sizing"/>
			</p>
			...
			<p style="clear:both; text-align: center;">
				<input type="button" value="회원가입" id="joinResult" class="sizing"/>
	...
	$(function() {
		$('#joinResult').click(function() {
			if($('#pw').val()==$('#pwConfirm').val()){
				document.joinIndiForm.action = 'joinIndi';
